        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Customers_CreditCards_IdCreditCard",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SaleLines_Products_IdProducto",
                        column: x => x.IdProducto,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SaleLines_Sales_IdSale",
                        column: x => x.IdSale,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Customers_IdCreditCard",
                table: "Customers",
                column: "IdCreditCard",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SaleLines_IdProducto",
                table: "SaleLines",
                column: "IdProducto");

            migrationBuilder.CreateIndex(
                name: "IX_SaleLines_IdSale",
                table: "SaleLines",
                column: "IdSale");
        }
